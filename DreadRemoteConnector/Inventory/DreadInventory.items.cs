...
public partial class DreadInventory
{
	...
	public static IReadOnlyList<string> DefaultItemsOfInterest { get; } = [
		Items.MaxMissileCapacity,
		Items.MaxEnergyCapacity,
		Items.MaxPowerBombCapacity,
		Items.WideBeam,
		Items.PlasmaBeam,
		Items.WaveBeam,
		Items.ChargeBeam,
		...
		Items.FlashShift,
		Items.PulseRadar,
		Items.FlashShiftUpgrade,
		Items.SpeedBoosterUpgrade,
		..Items.AllMetroidDnaItems,
	];
